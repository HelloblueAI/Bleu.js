...
**See also:** [Repositories and sync](REPOSITORIES.md) — how both repos fit together and stay in sync. **Who serves the live API:** [Who serves the API](WHO_SERVES_THE_API.md) (bleujs.org Next.js/Vercel; Bleu.js is client-only). **Live API status:** [Smoke test results](SMOKE_TEST_RESULTS.md). **Issue/solution reference:** [Issues and solutions](archive/maintainer/ISSUES_AND_SOLUTIONS.md) (config show, chat timeout, generate/embed 500; maintainer archive).
