...
1. **Do not re-add a `backend/` tree.** That directory is gitignored. The OpenAPI stub lives in `services/edge-stub/`. Keeping it there avoids a second npm and pip manifest set in this repo.
