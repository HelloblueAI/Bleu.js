...
Historical notes, superseded guides, and **maintainer runbooks**. Not the primary path for new contributors.

## Where to start instead

| Audience | Start here |
|----------|------------|
| **Users** | [GET_STARTED](../GET_STARTED.md) or the root [README](../../README.md) |
| **Contributors** | [CONTRIBUTING](../CONTRIBUTING.md) and [CONTRIBUTOR_GUIDE](../CONTRIBUTOR_GUIDE.md) |
| **Install** | [INSTALLATION](../INSTALLATION.md) (current commands and versions) |
...
Do not add new docs here. Add to `docs/` (public) or `docs/archive/maintainer/` (ops runbooks).
