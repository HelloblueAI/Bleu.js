...
def main():
    ...
    parser = argparse.ArgumentParser(description="Bleu.js - Quantum-Enhanced Vision System")
    parser.add_argument("--input", "-i", required=True, help="Input image path")
    parser.add_argument("--output", "-o", help="Output directory for results")
    parser.add_argument("--confidence", "-c", type=float, default=0.1, help="Confidence threshold")
