...
class MultimodalProcessor:
    ...
    def _combine_results(self, results: List[Tuple[np.ndarray, float]]) -> Tuple[np.ndarray, Dict[str, float]]:
    ...
    def _calculate_fusion_weights(self, confidences: Dict[str, float]) -> Dict[str, float]:
