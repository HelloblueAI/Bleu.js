...
class VisionProcessor:
    ...
    def _preprocess_image(self, image: np.ndarray) -> np.ndarray:
        ...
        # Resize image
        image = cv2.resize(image, (self.config.max_image_size, self.config.max_image_size))
    ...
    def _post_process_results(self, results: Dict) -> Dict:
        ...
        return {
            ...
            'attributes': self._process_attribute_recognition(results['attribute_recognition'])
        }
