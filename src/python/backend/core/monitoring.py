...
class MonitoringSystem:
    ...
    def _setup_metrics(self):
        ...
        self.memory_gauge = prom.Gauge('system_memory_percent', 'Memory usage percentage')
        ...
        self.response_time = prom.Histogram('app_response_time_seconds', 'Response time')
    ...
    async def collect_application_metrics(self) -> ApplicationMetrics:
        ...
        metrics = ApplicationMetrics(
            ...
            average_response_time=self.response_time._sum.get() / max(1, self.response_time._count.get()),
    ...
    async def get_performance_report(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'application': {
                ...
                'error_rate': app_metrics.error_count / max(1, app_metrics.request_count),
