...
class QuantumErrorCorrection:
    ...
    def encode(self, state: np.ndarray) -> np.ndarray:
        ...
        if self.code_type == 'stabilizer':
            ...
            raise ValueError(f"Unsupported error correction code type: {self.code_type}")
...
class BleusQuantumErrorCorrection:
    ...
    def encode_bleus(self, state: np.ndarray) -> np.ndarray:
        ...
        if self.code_type == 'bleus_stabilizer':
            ...
            raise ValueError(f"Unsupported Bleus error correction code type: {self.code_type}")
