"""
Test-only settings for Bleu.js.

Used when TESTING=true (e.g. pytest, integration tests). Kept in src so
production code never imports from the tests package.
"""
...
class TestSettings(BaseSettings):
    """Settings used when running with TESTING=true."""
...
def get_test_settings() -> TestSettings:
    """Return cached test settings. Only use when TESTING=true."""
    return TestSettings()
