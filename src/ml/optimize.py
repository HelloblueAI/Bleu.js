...
class ModelOptimizer:
    ...
    def objective(self, trial):
        ...
        param = {
            ...
            'neural_network_lr': trial.suggest_loguniform('neural_network_lr', 1e-4, 1e-2),
        }
        ...
        for train_idx, val_idx in kf.split(X_scaled):
            ...
            # Train XGBoost model
            xgb_model = xgb.XGBClassifier(**{k: v for k, v in param.items() if k not in ['batch_size', 'epochs', 'neural_network_lr']}, random_state=42)
    ...
    def train_final_model(self):
        ...
        importance_path = os.path.join(self.output_dir, f'feature_importance_{timestamp}.json')
