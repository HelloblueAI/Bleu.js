...
class QuantumIntelligence:
    ...
    async def _process_quantum_features(
        ...
        quantum_features = await self._apply_quantum_transformations(
            quantum_features
        )
    ...
    def _calculate_confidence(self, predictions: np.ndarray) -> float:
        ...
        probabilities = predictions if len(predictions.shape) > 1 else np.array([1 - predictions, predictions]).T
