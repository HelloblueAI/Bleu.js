...
async def main():
    ...
    for epoch in range(n_epochs):
        ...
        config.quantum_feature_ratio = updated_state.get('quantum_feature_ratio', config.quantum_feature_ratio)
    ...
    if learning_history:
        ...
        print(f"- Performance improvement: {final_metrics.performance_score - initial_metrics.performance_score:.4f}")
        print(f"- Quantum speedup improvement: {final_metrics.quantum_speedup - initial_metrics.quantum_speedup:.2f}x")
        print(f"- Error rate reduction: {initial_metrics.error_rate - final_metrics.error_rate:.4f}")
