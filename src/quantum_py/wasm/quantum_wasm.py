...
class QuantumWASM:
    ...
    def prepare_quantum_state(
        ...
        try:
            ...
            # Call WASM function
            state_ptr = instance.exports.prepare_quantum_state(
                self.store,
                data_ptr
            )
    ...
    def compute_quantum_entropy(
        ...
        try:
            ...
            # Call WASM function
            entropy = instance.exports.compute_quantum_entropy(
                self.store,
                state_ptr
            )
    ...
    def _allocate_memory(self, data: Union[np.ndarray, List, str]) -> int:
        ...
        try:
            ...
            ptr = instance.exports.allocate_memory(
                self.store,
                len(data_bytes)
            )
    ...
    def _read_memory(self, ptr: int) -> np.ndarray:
        ...
        try:
            ...
            # Get memory size
            size = instance.exports.get_memory_size(
                self.store,
                ptr
            )
