...
4. **Auto-release** - Version bumping on main
5. **Upload Model HF** - HuggingFace integration
6. **OpenAPI Validate** - API schema validation
7. **Welcome** - New contributor automation
8. **Auto-assign** - PR assignment
